...
% Makes Individual graphs then makes the graphs using subplots
% The subplots ones may be easier to understand
...
% axis([0.5 4.5 .4 .8]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('SE of ABSOLUTE Miss Angle');title('Standard error ABS for each target');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(AbsMissDataArray(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(AbsMissDataArray(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
% axis([0.5 5.5 .4 .77]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('Standard Error');title('Condition Target ABS Miss SE');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        target=target_cells{k};
        ColorPref(k)=plot(c,mean(MoveAngleArray(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(MoveAngleArray(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(PathLTargetToTargetArray(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(PathLTargetToTargetArray(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .1028 .108]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL to Taget');title('Target Condition to PathL to Target');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;

%By Condition (to Target)
figure(figure_count);
clear ColorPref;
hold on;
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(PathLTargetToTargetArray(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(PathLTargetToTargetArray(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end

% axis([.5 5.5 .102 .1078]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('Path Length To Target');title('Condition Target to PathL to Target');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(PathLTargetAllArray(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(PathLTargetAllArray(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .233 .28]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL All');title('Target Condition to PathL All');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(PathLTargetAllArray(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(PathLTargetAllArray(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
% axis([.5 5.5 .234 .28]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('PathL All');title('Condition Target to PathL All');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(MaxExArray(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(MaxExArray(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .233 .28]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL to Taget');title('Target Condition to MaxEx');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(MaxExArray(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(MaxExArray(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
% axis([.5 5.5 .234 .28]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('Path Length To Target');title('Condition Target to MaxEx');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(PathLTargetToTargetArrayNorm(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(PathLTargetToTargetArrayNorm(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .1028 .108]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL to Taget');title('Target Condition to PathL to Target NORM');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(PathLTargetToTargetArrayNorm(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(PathLTargetToTargetArrayNorm(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end

% axis([.5 5.5 .102 .1078]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('Path Length To Target');title('Condition Target to PathL to Target NORM');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(PathLTargetAllArrayNorm(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(PathLTargetAllArrayNorm(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .233 .28]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL All NORM');title('Target Condition to PathL All NORM');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(PathLTargetAllArrayNorm(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(PathLTargetAllArrayNorm(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
% axis([.5 5.5 .234 .28]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('PathL All NORM');title('Condition Target to PathL All NORM');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
for c=1:nc
    for k=1:4
        target=target_cells{k};        
        ColorPref(c)=plot(k,mean(MaxExArrayNorm(c,:,k)),'o','Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
    end
    line(1:4)=mean(MaxExArrayNorm(c,:,:),2);
    plot(line,'Color',ColorSet(c*3,:),'MarkerFaceColor',ColorSet(c*3,:));
end
% axis([.5 4.5 .233 .28]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL to Taget');title('Target Condition to MaxEx NORM');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
for k=1:4
    for c=1:nc
        ...
        ColorPref(k)=plot(c,mean(MaxExArrayNorm(c,:,k)),'o','Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
    end
    plot(mean(MaxExArrayNorm(:,:,k),2),'Color',ColorSet(k*3,:),'MarkerFaceColor',ColorSet(k*3,:));
end
% axis([.5 5.5 .234 .28]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('Path Length To Target');title('Condition Target to MaxEx NORM');
legend([ColorPref(:)],target_cells(:));
figure_count=figure_count+1;
...
% axis([.5 4.5 .93 1.01]);
set(gca,'XTick',[0,1,2,3,4,5]);
xlabel('Target Number');ylabel('PathL All');title('Target Condition to PathL All NORM');
legend([ColorPref(:)],conditions(:));
figure_count=figure_count+1;
...
% axis([.5 5.5 .234 .28]);
set(gca,'XTick',[0,1,2,3,4,5],'XtickLabel',[' ' conditions ' ']);
xlabel('Condition');ylabel('PathL All NORM');title('Condition Target to PathL All');
legend([ColorPref(:)],target_cells(:));
