...
%             initvector=[Data.x(MT.idxonset(i)+5,i),...
%                         Data.y(MT.idxonset(i)+5,i),0];
%             targetvector=[Data.targetposition(i,1)-Data.targetposition(i-1,1)...
%                 ,Data.targetposition(i,2)-Data.targetposition(i-1,2),0];
%             missvector=[Data.x(MT.idxendpt(i),i)-Data.targetposition(i-1,1),...
%                 Data.y(MT.idxendpt(i),i)-Data.targetposition(i-1,2),0];
%             
%             initvector=[Data.x(MT.idxonset(i)+5,i),...
%                     Data.y(MT.idxonset(i)+5,i),0];
%                 targetvector=[Data.targetposition(i,1)...
%                     ,Data.targetposition(i,2),0];
%                 missvector=[Data.x(MT.idxmoveback(i),i),...
%                         Data.y(MT.idxmoveback(i),i),0];
%                     
%         if Data.p(MT.idxendpt(i),i)<.07 || Data.miss_dist(i) > .01
%             1;
%         end
...
%         MT.idxvthresh_onset(i) = find(V(1:MT.idxendpt(i),i)*vsign(i)>0.01,1,'first')+1;
        MT.idxvthresh_onset(i) = find(Data.TanV(MT.robotstates.wait4mvt(i):MT.idxendpt(i),i)>0.01,1,'first')+MT.robotstates.wait4mvt(i);
